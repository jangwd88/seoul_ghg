/**
 * activeintra: a module for AIReport Namespace
 */

var activeintra;
if (!activeintra) activeintra = {};

activeintra.Class = {};
/**
 * activeintra.Class.define( ) -- a utility function for defining JavaScript classes.
 *
 ...
 **/
activeintra.Class.define = function(data) {
