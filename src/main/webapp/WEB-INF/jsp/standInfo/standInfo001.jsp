		...
		<div class="main-content">
			<div class="content-heading">
				<div class="heading-left">
					<h1 class="page-title">배출원 관리(직접)</h1>
					<p class="page-subtitle">서울특별시 인벤토리 직접 배출원별 계수 관리</p>
				</div>
			</div>
						...
						<div class="card">
							<form name="searchFrm" id="searchFrm">
								<div class="project-heading">
									<div class="row">
										<div class="checkDiv">
											<button type="button" class="btn btn-primary" aria-expanded="false" >고정연소</button>
											<button type="button" class="btn btn-primary" aria-expanded="false" >이동연소</button>
										</div>
									</div>
									<hr class="hrSelect">
								</div>
								...
								<div class="col-lg-12" style="max-height: 300; overflow-y: auto">
									...
									<table id="listTable" class="table table-striped table-project-tasks">
										...
										<tr>
											...
											<td rowspan="2" style="word-break: normal;">산화율</td>
											<td rowspan="2" style="word-break: normal;">배출활동구분</td>
											<td colspan="5" style="word-break: normal;">산정 Tier</td>
										</tr>
										<tr>
											<td style="word-break: normal;">산정식</td>
											<td style="word-break: normal;">연료량</td>
											<td style="word-break: normal;">발열량</td>
											<td style="word-break: normal;">배출계수</td>
											<td style="word-break: normal;">산화율</td>
										</tr>
										</thead>
										<tbody>
											<tr>
								...
								<div class="row">
									...
									<table id="listTable" class="table table-striped table-project-tasks">
										...
										<tr>
											...
											<td rowspan="2" style="word-break: normal;">순발열량 <br> (MJ / 정부보고 단위)</td>
