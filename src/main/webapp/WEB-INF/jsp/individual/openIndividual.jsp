...
<body>
		...
		<div class="main-content">
			...
			<div class="content-heading">
				<div class="heading-left">
					<h1 class="page-title">즐겨찾는 건축물</h1>
					<p class="page-subtitle">관심 건축물 상세 조회</p>
				</div>
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item">개인화 서비스</li>
						<li class="breadcrumb-item active">
							<a href="/individual/openIndividual.do">즐겨찾는 건축물</a>
						</li>
					</ol>
				</nav>
			</div>
							...
							<div class="card-body" style="padding-top: 5px;">
								...
								<div class="card project-milestone">
									<div id="collapse4" class="collapse show">
										<div id="map" class="specArchMap" style="height: 550px;"></div>
									</div>
								</div>
									...
									<table id="searchedBuildTable" class="table table-striped" summary="조회 결과" style="table-layout: fixed; height: 50px; width: 1580px;">
										...
										<tbody id="searchedBuildResult">
											<tr style="text-align: center; font-size: 13px;">
												<td colspan="6">즐겨찾는 건물을 등록해주세요.</td>
											</tr>
										</tbody>
									</table>
								</div>
	...
	<!-- SPACE.JS -->
	<script src="/resources/js/openIndividual.js"></script>
