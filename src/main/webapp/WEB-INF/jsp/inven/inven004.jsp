...
<script>
 function search(){
	 ...
	 callAjax("${pageContext.request.contextPath}/inven/inven004_search.do", true, 'json', param, function(data){
		 var utilList = $("#util").val() != null && $("#util").val() != "" ? $("#util").val().split(",") : "";
			...
			if (isNoData) {
				...
				tr += '<tr>'
				tr += '<td colspan="' + (searchYearCnt + 5) + '">조회된 데이터가 없습니다.</td>'
				tr += '</tr>'
			}
			tr += '</tbody>'
			$("#listTable").append(tr);
		...
		<nav>
			<ul class="nav" id="sidebar-nav-menu">
				...
				<li class="panel"><a href="#inven" data-toggle="collapse" data-parent="#sidebar-nav-menu" aria-expanded="" class=""> <i class="ti-layout-grid2"></i> <span class="title">인벤토리</span> <i
					...
					<div id="inven" class="collapse  show">
						<ul class="submenu">
							...
							<!-- <li><a href="/inven/inven004.do" class="active">GPC 조회</a></li> -->
						</ul>
					</div></li>
		...
		<div class="main-content">
			...
			<div class="content-heading">
				<div class="heading-left">
					<h1 class="page-title">GPC 조회</h1>
					<p class="page-subtitle">서울특별시 인벤토리 GPC형식 년간 검색</p>
				</div>
			</div>
...
function excelExport() {
		ExcellentExport.excel(this, 'listTable', "GPC 조회", "GPC 조회", "name");
	}
