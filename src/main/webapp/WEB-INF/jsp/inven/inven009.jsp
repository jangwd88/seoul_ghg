	...
	function search() {
		...
		callAjax("${pageContext.request.contextPath}/inven/inven001_search.do",false,'json',param, function(data) {
			...
			for (var i = 0; i < utilList.length; i++) {
				tr += '<td style="word-break: normal;">' + data[0]["FIX_YN_" + utilList[i]] + '</td>';
			}
			tr += '</tr> ';
			tr += '<tr>';
			for (var i = 0; i < utilList.length; i++) {
		...
		<div class="main-content">
			<div class="content-heading">
				<div class="heading-left">
					<h1 class="page-title">인벤토리 추세</h1>
					<p class="page-subtitle">서울특별시 인벤토리 추세 검색</p>
				</div>
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item">인벤토리 추세</li>
					</ol>
				</nav>
			</div>
