...
<script>
	...
	function search() {
		...
		callAjax("${pageContext.request.contextPath}/inven/inven002_search.do",
...
<body>
		...
		<div class="main-content">
			<div class="content-heading">
				<div class="heading-left">
					<h1 class="page-title">직간접 조회</h1>
					<p class="page-subtitle">서울특별시 인벤토리 직접(Scope1)배출,간접(Scope2)배출별 년간 검색</p>
				</div>
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">
							<a href="/stat/stat001.do">직.간접 조회</a>
						</li>
					</ol>
				</nav>
			</div>
	...
	<script>
		...
		function excelExport() {
			ExcellentExport
					.excel(this, 'listTable', "직간접 조회", "직간접 조회", "name");
		}
	...
	<form id="aiForm" name="aiForm" method="post">
		...
		<input type="hidden" name="reportID" id="reportID" value="direct">
